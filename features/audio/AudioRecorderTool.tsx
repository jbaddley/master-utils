      ...
      {audioUrl && blob && (
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          ...
          <p style={{ fontSize: "12px", color: "var(--muted-foreground)" }}>
            Saved as WebM/Opus — most players and editors support this format. Use the <a href="/audio-converter" style={{ color: "var(--primary)" }}>audio converter</a> to convert to MP3 or WAV.
          </p>
        </div>
      )}
    </div>
