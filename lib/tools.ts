...
export const TOOLS: Tool[] = [
  {
    ...
    title: "Image Studio",
    nav: "Image Studio",
    tagline: "Drop once, then compress, resize, crop, convert, remove background, strip EXIF, redact, or upscale.",
    icon: LuImage,
  },
  {
    slug: "image-to-svg",
  ...
  },
  {
    ...
    title: "Audio Studio",
    nav: "Audio Studio",
    tagline: "Drop once, then trim, fade, mix lanes, normalize, change speed or pitch, and export.",
    icon: LuMusic,
  },
  {
    slug: "convert-video",
